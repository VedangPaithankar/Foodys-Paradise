        ...
        <nav className="custom-font bg-white p-2 md:p-10 z-[50] font-fam-bold mx-auto fixed top-0 w-full">
            <div className="container mx-auto flex md:flex-row flex-col items-center">
                ...
                <div className={`md:mt-4 text-xl md:text-lg text-center justify-center md:flex md:gap-2 items-center ${isMobileMenuOpen ? 'flex flex-col open' : 'hidden'}`}>
                    ...
                    <Link to="/search" className="underline-effect-pink hover:text-[#D1547E] nav-link mb-4 md:mr-2" onClick={handleLinkClick}>Search</Link>
                    <Link to="/fridge" className="underline-effect-pink hover:text-[#D1547E] nav-link mb-4 md:mr-2" onClick={handleLinkClick}>MyFridge</Link>
                </div>
            </div>
        </nav>
    );
